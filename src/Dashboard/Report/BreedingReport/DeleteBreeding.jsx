...
function  DeleteBreeding({openDelete,breeding}) {
  const[loading,setLoading]=useState(false)
    const handeleDelete = ()=>{
 setLoading(true)
        axiosclient.delete(`/api/v1/Activity/deleteActivity/${breeding._id}`).then(()=>{
        ...
        //   alert(error)
Notiflix.Notify.failure('Activity not found')
        })
       }
  return (
<div className='activity-model-wrapper'>
      <div className="delete-body">
        <h2>Breeding Report delete</h2>
