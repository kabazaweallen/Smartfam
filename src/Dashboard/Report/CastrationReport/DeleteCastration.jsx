...
function  DeleteCastration({openDelete,cast}) {
  const[loading,setLoading]=useState(false)
    const handeleDelete = ()=>{
 setLoading(true)
        axiosclient.delete(`/api/v1/Activity/deleteActivity/${cast._id}`).then(()=>{
...
<div className='activity-model-wrapper'>
      <div className="delete-body">
        <h2>Castration Report delete</h2>
...
export default DeleteCastration