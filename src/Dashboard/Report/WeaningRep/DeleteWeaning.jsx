...
function DeleteWeaning({openDelete,weaning}) {
  const[loading,setLoading]=useState(false)
    const handeleDelete = ()=>{
 setLoading(true)
        axiosclient.delete(`/api/v1/Activity/deleteActivity/${weaning._id}`).then(()=>{
...
<div className='activity-model-wrapper'>
      <div className="delete-body">
        <h2>Cattle delete</h2>
        <p>are you sure you want to delete this report{weaning._id}  </p>
